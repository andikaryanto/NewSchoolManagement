                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="text-right">
                        <button type="button" rel="tooltip" class="btn btn-primary btn-round btn-fab" title="<?= lang('ui_add')?>" onclick="window.location.href='<?= base_url('mpeople/add');?>'">
                            ...
                            <table data-page-length="<?= $_SESSION['usersettings']['RowPerpage']?>" id = "tablePeople" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                              ...
                              ?>
                                  <tr role = "row" id = <?= $value->Id?>>
                                    <td><?= $value->Name?></td>
                                    <td><?= $value->get_M_Village()->Name?></td>
                                    <td><?= $value->Address?></td>
                                    <td><?= $value->Created?></td>
  ...
  function dataTable(){
    ...
    var table = $('#tablePeople').DataTable();
     ...
     table.on( 'click', '.edit', function () {
        ...
        var id = $tr.attr('id');
        window.location = "<?= base_url('mpeople/edit/');?>" + id;
     } );
