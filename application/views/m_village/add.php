          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">                 
                  <form method = "post" action = "<?= base_url('mvillage/addsave');?>">
                    <div class="form-group">
                      <label><?= lang('ui_name')?></label>
                      <input id="named" type="text"  class="form-control" name = "named" value="<?= $model->Name?>" required>
                    </div>
                    <div class="form-group">
                      <label><?= lang('ui_subcity')?></label>
                      <div class="input-group has-success">
                        
                        <input hidden id = "subcityid" type="text" class="form-control" name = "subcityid" value="<?= $model->M_Subcity_Id?>">
                        <input id = "subcityname" type="text" class="form-control custom-readonly"  value="<?= $model->get_M_Subcity()->Name?>" readonly>
                        <!-- <span class="form-control-feedback text-primary">
                            <i class="material-icons">search</i>
                        </span> -->
                        <div class="input-group-append">
                          <button id="btnSubcityModal" data-toggle="modal" type="button" class="btn btn-primary" data-target="#modalSubcities"><i class="fa fa-search"></i></button>
                        </div>
                      </div>
                    </div>
                    <div class="form-group">       
               ...
               <!-- modal -->
<div id="modalSubcities" tabindex="-1" role="dialog" aria-labelledby="subcityModalLabel" aria-hidden="true" class="modal fade text-left">
  <div role="document" class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 id="subcityModalLabel" class="modal-title"><?= lang('ui_subcity')?></h5>
