...
<head>
  ...
  <!-- CSS Files -->
  <link href="<?php echo base_url('assets/material-dashboard/assets/css/material-dashboard.green.min.css');?>" rel="stylesheet" />
  <link href="<?php echo base_url('assets/material-dashboard/assets/css/animate.css');?>" rel="stylesheet" />
  <link href="<?php echo base_url('assets/material-dashboard/assets/css/custom.css');?>" rel="stylesheet" />
