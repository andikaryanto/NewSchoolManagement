          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="text-right">
                        <button type="button" rel="tooltip" class="btn btn-primary btn-round btn-fab" title="index" onclick="window.location.href='<?= base_url('mclass');?>'">
                ...
                <div class="card-body">                 
                  <form method = "post" action = "<?= base_url('mclass/editsave');?>">
