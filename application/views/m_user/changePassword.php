            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
									<div class="row">
                    <div class = "col-lg-10">
                      <h4><?php echo lang('ui_changepassword')?></h4> 
                    </div>
                  </div>
                </div>
                <div class="card-body">
                  ...
                  <form method = "post" action = "<?php echo base_url('saveChangePassword');?>">
                    <div class="form-group">
                      ...
                      <input id="oldpassword" type="password" placeholder="<?php echo lang('ui_oldpassword')?>" class="form-control" name = "oldpassword" value="<?php echo $model['oldpassword']?>" required>
                    </div>
                    <div class="form-group">
                      <label><?php echo lang('ui_newpassword')?></label>
                      <input id="newpassword" type="password" placeholder="<?php echo lang('ui_newpassword')?>" class="form-control" name = "newpassword" value="<?php echo $model['newpassword']?>" required>
                    </div>
                    <div class="form-group">
                      <label><?php echo lang('ui_confirmpassword')?></label>
                      <input id="confirmpassword" type="password" placeholder="<?php echo lang('ui_confirmpassword')?>" class="form-control" name = "confirmpassword" value="<?php echo $model['confirmpassword']?>" required>
                    </div>
                    <div class="form-group">       
